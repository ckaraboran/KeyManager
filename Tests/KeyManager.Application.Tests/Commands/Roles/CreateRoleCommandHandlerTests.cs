...
public class CreateRoleCommandHandlerTests
{
    ...
    [Fact]
    public async Task Given_RoleCreate_When_WithGivenCreateRoleCommand_Then_ShouldReturnCreateRoleDto()
    {
        //Arrange
    ...
    [Fact]
    public async Task Given_RolePost_When_RecordAlreadyExists_Then_ShouldThrowExistingRecordException()
    {
        //Arrange
