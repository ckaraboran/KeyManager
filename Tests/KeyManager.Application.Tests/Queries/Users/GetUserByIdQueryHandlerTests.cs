...
public class GetUserByIdQueryHandlerTests : IDisposable
{
    ...
    [Fact]
    public async Task Given_UserGet_When_WithGivenId_Then_ShouldReturnUserDto()
    {
        //Arrange
    ...
    [Fact]
    public async Task Given_UserGet_When_WithNotExistUsername_Then_ShouldThrowNotFoundException()
    {
        //Arrange
