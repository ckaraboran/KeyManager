...
public class RoleControllerTests
{
    ...
    [Fact]
    public async Task Given_GetRoleCommand_When_Get_Then_ShouldReturnAllRoles()
    {
        //Arrange
    ...
    [Fact]
    public async Task Given_RoleGet_When_WithGivenId_Then_ShouldReturnAllRole()
    {
        //Arrange
    ...
    [Fact]
    public async Task Given_RolePost_When_WithGivenRole_Then_ShouldAddRole()
    {
        //Arrange
    ...
    [Fact]
    public async Task Given_RolePut_When_WithGivenRole_Then_ShouldUpdateRole()
    {
        //Arrange
    ...
    [Fact]
    public async Task Given_RoleDelete_When_WithGivenRole_Then_ShouldDeleteRole()
    {
        //Arrange
